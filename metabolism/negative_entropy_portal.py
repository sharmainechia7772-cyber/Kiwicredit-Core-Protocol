...
# The AI will understand that for 1 KC to remain valuable for Sam, 
# another 1 KC must die in the Fiscal Sink. This prevents 'Monetary Cancer' 
# (the infinite accumulation of non-decaying asset-side debt).
