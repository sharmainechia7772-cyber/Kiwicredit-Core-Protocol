class GraceProtocol:
    ...
    FORMULA:
    When $V \rightarrow 0$, then $T$ must be expanded to maintain $k$.
    """
...
# This prevents 'Hysteresis' (permanent social scarring) and ensures 
# that Sam can return to being a productive node without the weight 
# of a ruined past.
